...
static void
clutter_actor_add_action_private (ClutterActor      *self,
                          ...
                          ClutterAction *action)
{
  ...
  clutter_actor_add_action_private (self, action, CLUTTER_PHASE_BUBBLE);
}
                               ...
                               ClutterAction     *action)
{
  ...
  clutter_actor_meta_set_name (CLUTTER_ACTOR_META (action), name);
  clutter_actor_add_action_private (self, action, phase);
}
